...
use App\Http\Controllers\Api\Web\WeiYanController;
...
Route::name('api')->group(function() {
    ...
    Route::middleware('throttle:'. config('api.rate_limits.sign'))->group(function () {
        ...
        // 用户退出登录
        Route::delete('user/logout', [UsersController::class, 'logout'])->name('user.logout');
    ...
    Route::middleware('throttle:'. config('api.rate_limits.access'))->group(function () {
        ...
        Route::middleware('auth:api')->middleware('refresh.token')->group(function() {
            ...
            /** 微言开始 */
            // 微言列表
            Route::get('web/wei-yan/list', [WeiYanController::class, 'index'])->name('web.wei-yan.index');
            // 添加微言
            Route::post('web/wei-yan/', [WeiYanController::class, 'add'])->name('web.wei-yan.add');
            // 删除微言
            Route::delete('web/wei-yan/{wei-yan}', [WeiYanController::class, 'delete'])->name('web.wei-yan.delete');
            /** 微言结束 */
        });
    });
